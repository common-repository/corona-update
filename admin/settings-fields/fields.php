...
class Fields{
    ...
    private static $optionName = 'coronaupdate_options';
    ...
    public function init() {
        ...
        $this->include_fiels();
        //
        add_filter( 'coronaupdate_get_settings_opt', [$this, 'option_flug'] );
    ...
    public function enqueueScripts() {
        ...
        wp_enqueue_style( 'coronaupdate-settings-field', self::$pluginUrl.'assets/css/fields.css', array(), '1.0', false );
        wp_enqueue_script( 'coronaupdate-settings-field', self::$pluginUrl.'assets/js/fields.js', array( 'jquery', 'wp-color-picker' ), '1.0', true );
    }
